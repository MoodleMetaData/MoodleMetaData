...
/**
 * block_course_message mail_sent event.
 * 
...
class mail_sent extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventmailsent', 'block_course_message');
    }

    public function get_description() {
        return "User {$this->userid} sent mail message {$this->objectid} " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, get_string('pluginname', BLOCK_CM_LANG_TABLE), 'mail send', '',
                     'sent mail, mailid: ' . $this->objectid, $this->objectid, $this->contextinstanceid);
    }
}
