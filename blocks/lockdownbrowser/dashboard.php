<?php
	...
	if (!has_capability('moodle/course:manageactivities',
        context_course::instance($lockdownbrowser_urlcourse))) {
	...
	echo "Please wait ...";
	echo "</div>";
	echo "<iframe  id=\"ldbFrame\" src=\"$lockdownbrowser_iframe_url\" onload=\"ldb_HideFrameWait()\" scrolling=\"no\" frameborder=\"0\" width=\"100%\" height=\"10000px\">";
