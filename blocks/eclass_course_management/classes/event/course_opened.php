...
class course_opened extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcourseopened', 'block_eclass_course_management');
    }
    ...
    public function get_description() {
        ...
        return
            "User with user id: {$this->userid} opened course by setting start date to: {$startdate} and ".
            "end date to: {$enddate}.";
    }
}