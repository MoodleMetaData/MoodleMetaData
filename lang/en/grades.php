...
$string['updatedafterload'] = 'The grade you entered ({$a->postedvalue}) for {$a->itemname}, {$a->username} was updated after you loaded the page.';
...
$string['showempid'] = 'Show Student ID';
$string['showempid_help'] = 'Enables the ability to view the Student ID column in the grader report';
$string['lockedgradebook'] = 'Note: This gradebook has been locked to prevent possible grade changes due to the presence of particular gradebook configuration options.';
