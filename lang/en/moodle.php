...
$string['serverlocaltime'] = 'Server\'s local time (Edmonton, Alberta)';
...
$string['timezone_help'] = 'If you are in Alberta, select "Server\'s local time". Otherwise, you can set your local timezone.  Note that timezones based on UTC offsets do not account for Daylight Saving Time.';
$string['to'] = 'To';
