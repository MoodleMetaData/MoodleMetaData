...
global $PAGE;
$PAGE->requires->yui_module('moodle-group-selectsizecorrection', 'M.init_selectsizecorrection',
    array(array('lineCount'=>USER_SELECTOR_DEFAULT_ROWS)));
...
abstract class user_selector_base {
    ...
    public function display($return = false) {
        ...
        $output = '<div class="userselector" id="' . $this->name . '_wrapper">' . "\n" .
                '<div  class="select_wrapper"><select name="' . $name . '" id="' . $this->name . '" ' .
                $multiselect . 'size="' . $this->rows . '" class="select-full-height">' . "\n";
