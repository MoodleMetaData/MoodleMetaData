...
<?php echo $OUTPUT->eclass_header(1); ?>

<div id="page" class="container-fluid" data-page-count="2">
    ...
    <div id="page-content" class="row-fluid">
        ...
        <section id="region-main" class="span12 column1">
            <?php
        ...
        <?php echo $OUTPUT->eclass_profile('column1'); ?>
    </div>
