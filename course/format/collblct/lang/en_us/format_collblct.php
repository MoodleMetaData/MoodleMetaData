...
$string['resetcolour_help'] = 'Resets the colors to the default values so it will be the same as a course the first time it is in the Collapsed Topics with Collapsed Labels format.';
$string['resetallcolour_help'] = 'Resets the colors to the default values for all courses so it will be the same as a course the first time it is in the Collapsed Topics with Collapsed Labels format.';
