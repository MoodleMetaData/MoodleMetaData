...
class format_collblct extends format_base {
    ...
    public function get_collblct_section_name($course, $section, $additional) {
        ...
        if (($additional == true) && ($thesection->section != 0)) {
            switch ($tcsettings['layoutelement']) {
                ...
                case 3:
                case 4:
                    $o .= '<span class="cttoggle"> - ' . get_string('collblcttoggle', 'format_collblct') . '</span>'; // The word 'Toggle'.
                    break;
            }
        }
    ...
    public function ajax_section_move() {
        ...
        if ($sections = $modinfo->get_section_info_all()) {
            foreach ($sections as $number => $section) {
                $titles[$number] = $this->get_collblct_section_name($course, $section, true);
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($courseformatoptions === false) {
            ...
            $courseformatoptions = array(
                ...
                'coursedisplay' => array(
                    'default' => get_config('format_collblct', 'defaultcoursedisplay'),
                    'type' => PARAM_INT,
                ),
                ...
                'readme' => array(
                    'default' => get_string('readme_desc', 'format_collblct', array('url' => $readme)),
                    'type' => PARAM_ALPHA,
                )
            );
        }
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            ...
            if (has_capability('format/collblct:changelayout', $coursecontext)) {
                $courseformatoptionsedit['layoutelement'] = array(
                    ...
                    'element_attributes' => array( // In insertion order and not numeric for sorting purposes.
                        array(1 => new lang_string('setlayout_all', 'format_collblct'),                             // Toggle word, toggle section x and section number.
                ...
                $courseformatoptionsedit['layoutstructure'] = array(
                    ...
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(1 => new lang_string('setlayoutstructuretopic', 'format_collblct'),             // Topic.
                ...
                $courseformatoptionsedit['layoutelement'] =
                    array('label' => get_config('format_collblct', 'defaultlayoutelement'), 'element_type' => 'hidden');
                $courseformatoptionsedit['layoutstructure'] =
                    array('label' => get_config('format_collblct', 'defaultlayoutstructure'), 'element_type' => 'hidden');
                $courseformatoptionsedit['layoutcolumns'] =
                    array('label' => get_config('format_collblct', 'defaultlayoutcolumns'), 'element_type' => 'hidden');
                $courseformatoptionsedit['layoutcolumnorientation'] =
                    array('label' => get_config('format_collblct', 'defaultlayoutcolumnorientation'), 'element_type' => 'hidden');
                $courseformatoptionsedit['toggleiconposition'] =
                    array('label' => get_config('format_collblct', 'defaulttoggleiconposition'), 'element_type' => 'hidden');
                $courseformatoptionsedit['showsectionsummary'] =
                    array('label' => get_config('format_collblct', 'defaultshowsectionsummary'), 'element_type' => 'hidden');
            }

            if (has_capability('format/collblct:changetogglealignment', $coursecontext)) {
                ...
                $courseformatoptionsedit['togglealignment'] =
                    array('label' => get_config('format_collblct', 'defaulttogglealignment'), 'element_type' => 'hidden');
            }

            if (has_capability('format/collblct:changetoggleiconset', $coursecontext)) {
                ...
                $courseformatoptionsedit['toggleiconset'] =
                    array('label' => get_config('format_collblct', 'defaulttoggleiconset'), 'element_type' => 'hidden');
                $courseformatoptionsedit['toggleallhover'] =
                    array('label' => get_config('format_collblct', 'defaulttoggleallhover'), 'element_type' => 'hidden');
            }

            if (has_capability('format/collblct:changecolour', $coursecontext)) {
    ...
    public function create_edit_form_elements(&$mform, $forsection = false) {
        ...
        if ($forsection == false) {
            ...
            $changelayout = has_capability('format/collblct:changelayout', $coursecontext);
            $changecolour = has_capability('format/collblct:changecolour', $coursecontext);
            $changetogglealignment = has_capability('format/collblct:changetogglealignment', $coursecontext);
            $changetoggleiconset = has_capability('format/collblct:changetoggleiconset', $coursecontext);
            ...
            $resetelements = array();
            $checkboxname = get_string('resetdisplayinstructions', 'format_collblct').$OUTPUT->help_icon('resetdisplayinstructions', 'format_collblct');
            ...
            if ($changetogglealignment) {
                $checkboxname = get_string('resettogglealignment', 'format_collblct').$OUTPUT->help_icon('resettogglealignment', 'format_collblct');
                $resetelements[] =& $mform->createElement('checkbox', 'resettogglealignment', '', $checkboxname);
            }

            if ($changetoggleiconset) {
                $checkboxname = get_string('resettoggleiconset', 'format_collblct').$OUTPUT->help_icon('resettoggleiconset', 'format_collblct');
            ...
            if ($resetall) {
                ...
                $checkboxname = get_string('resetalldisplayinstructions', 'format_collblct').$OUTPUT->help_icon('resetalldisplayinstructions', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetalldisplayinstructions', '', $checkboxname);

                $checkboxname = get_string('resetalllayout', 'format_collblct').$OUTPUT->help_icon('resetalllayout', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetalllayout', '', $checkboxname);

                $checkboxname = get_string('resetallcolour', 'format_collblct').$OUTPUT->help_icon('resetallcolour', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetallcolour', '', $checkboxname);

                $checkboxname = get_string('resetalltogglealignment', 'format_collblct').$OUTPUT->help_icon('resetalltogglealignment', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetalltogglealignment', '', $checkboxname);

                $checkboxname = get_string('resetalltoggleiconset', 'format_collblct').$OUTPUT->help_icon('resetalltoggleiconset', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetalltoggleiconset', '', $checkboxname);

                $elements[] = $mform->addGroup($resetallelements, 'resetallgroup', get_string('resetallgrp', 'format_collblct'), null, false);
            }
        }
    ...
    public function update_course_format_options($data, $oldcourse = null) {
        ...
        if (($resetalldisplayinstructions) || ($resetalllayout) || ($resetallcolour) || ($resetalltogglealignment) || ($resetalltoggleiconset)) {
            $this->reset_collblct_setting(0, $resetalldisplayinstructions, $resetalllayout, $resetallcolour, $resetalltogglealignment, $resetalltoggleiconset);
            $changes = true;
        } else if (($resetdisplayinstructions) || ($resetlayout) || ($resetcolour) || ($resettogglealignment) || ($resettoggleiconset)) {
            $this->reset_collblct_setting($this->courseid, $resetdisplayinstructions, $resetlayout, $resetcolour, $resettogglealignment, $resettoggleiconset);
            $changes = true;
        }
    ...
    public function reset_collblct_setting($courseid, $displayinstructions, $layout, $colour, $togglealignment, $toggleiconset) {
        ...
        if ($layout && has_capability('format/collblct:changelayout', $coursecontext) && $resetallifall) {
            $updatedata['coursedisplay'] = get_config('format_collblct', 'defaultcoursedisplay');
        ...
        if ($togglealignment && has_capability('format/collblct:changetogglealignment', $coursecontext) && $resetallifall) {
            $updatedata['togglealignment'] = get_config('format_collblct', 'defaulttogglealignment');
            $updatetogglealignment = true;
        }
        if ($colour && has_capability('format/collblct:changecolour', $coursecontext) && $resetallifall) {
        ...
        if ($toggleiconset && has_capability('format/collblct:changetoggleiconset', $coursecontext) && $resetallifall) {
     ...
     */
    public function restore_collblct_setting($courseid, $layoutelement, $layoutstructure, $layoutcolumns, $tgfgcolour, $tgbgcolour, $tgbghvrcolour) {
 ...
 * CONTRIB-3520.
 */
function format_collblct_delete_course($courseid) {
    global $DB;
    $DB->delete_records("user_preferences", array("name" => 'collblct_toggle_' . $courseid));
}