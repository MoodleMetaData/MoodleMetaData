...
if (!empty($displaysection)) {
    ...
    $PAGE->requires->js_init_call('M.format_collblct.init', array(
        $course->id,
        $userpreference,
        $course->numsections,
...
<?php
    ...
    .course-content ul.ctopics li.section.main .content, .course-content ul.ctopics li.tcsection .content {
        margin: 0 <?php echo get_string('collblctsidewidth', 'format_collblct'); ?>;
    }
<?php
...
<?php
    ...
    .course-content ul.ctopics li.section.main .side, .course-content ul.ctopics li.tcsection .side {
        width: <?php echo get_string('collblctsidewidth', 'format_collblct'); ?>;
    }
<?php
    }
