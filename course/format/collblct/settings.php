...
if ($ADMIN->fulltree) {
    $settings->add(new admin_setting_heading('format_collblct_defaults', get_string('defaultheadingsub', 'format_collblct'),
     ...
     */
    $name = 'format_collblct/defaultcoursedisplay';
    $title = get_string('defaultcoursedisplay', 'format_collblct');
    $description = get_string('defaultcoursedisplay_desc', 'format_collblct');
    ...
    $settings->add(new admin_setting_heading('format_collblct_configuration', get_string('configurationheadingsub', 'format_collblct'),
