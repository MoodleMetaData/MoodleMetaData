...
require_once(dirname(__FILE__) . '/libtest.php');
...
$ac->login      = $DB->get_field('config', 'value', array('name' => 'adobeconnect_admin_login'));
$ac->host       = $DB->get_field('config', 'value', array('name' => 'adobeconnect_host'));
$ac->port       = $DB->get_field('config', 'value', array('name' => 'adobeconnect_port'));
$ac->pass       = $DB->get_field('config', 'value',  array('name' => 'adobeconnect_admin_password'));
$ac->httpauth   = $DB->get_field('config', 'value', array('name' => 'adobeconnect_admin_httpauth'));
$ac->emaillogin = $DB->get_field('config', 'value', array('name' => 'adobeconnect_email_login'));
$ac->https      = $DB->get_field('config', 'value', array('name' => 'adobeconnect_https'));
