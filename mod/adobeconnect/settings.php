...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('adobeconnect_port', get_string('port', 'adobeconnect'),
                       get_string('port_desc', 'adobeconnect'), '443', PARAM_INT));
    ...
    $settings->add(new admin_setting_configcheckbox('adobeconnect_https', get_string('https', 'adobeconnect'),
        get_string('https_desc', 'adobeconnect') , '1'));

    $settings->add(new admin_setting_configtext('mod_adobeconnect/gettingstarted_host', get_string('admin_gettingstarted_host', 'adobeconnect'), '', ''));
    $settings->add(new admin_setting_configtext('mod_adobeconnect/troubleshooting_host', get_string('admin_troubleshooting_host', 'adobeconnect'), '', ''));
    $settings->add(new admin_setting_configtext('mod_adobeconnect/upcomingtraining_host', get_string('admin_upcomingtraining_host', 'adobeconnect'), '', ''));
    $settings->add(new admin_setting_configtext('mod_adobeconnect/outageschedule_host', get_string('admin_outageschedule_host', 'adobeconnect'), '', ''));
    $settings->add(new admin_setting_configtext('mod_adobeconnect/gettingstarted_particpant', get_string('admin_gettingstarted_particpant', 'adobeconnect'), '', ''));
    $settings->add(new admin_setting_configtext('mod_adobeconnect/troubleshooting_particpant', get_string('admin_troubleshooting_particpant', 'adobeconnect'), '', ''));

    $settings->add(new admin_setting_configtext('mod_adobeconnect/support_email', get_string('connect_support_email', 'adobeconnect'), '', ''));
