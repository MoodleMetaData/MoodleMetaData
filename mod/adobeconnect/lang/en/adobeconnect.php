...
$string['connect_support_email'] = 'Support email';
...
$string['info_hdr'] = 'eClass Live Information Resources';
$string['info_gettingstarted_host'] = 'eClass Live Getting Started Tip Sheet';
$string['info_troubleshooting_host'] = 'eClass Live Troubleshooting Tip sheet';
$string['info_upcomingtraining_host'] = 'eClass Live Upcoming Training Sessions';
$string['info_outageschedule_host'] = 'eClass Live Schedule of Outages';
$string['info_gettingstarted_particpant'] = 'eClass Live Getting Started Tip Sheet';
$string['info_troubleshooting_particpant'] = 'eClass Live Troubleshooting Tip sheet';

$string['admin_gettingstarted_host'] = 'Getting Started Host Tip Sheet link';
$string['admin_troubleshooting_host'] = 'Troubleshooting Host Tip sheet link';
$string['admin_upcomingtraining_host'] = 'Upcoming Training Sessions link';
$string['admin_outageschedule_host'] = 'Schedule of Outages link';
$string['admin_gettingstarted_particpant'] = 'Getting Started Participant Tip Sheet link';
$string['admin_troubleshooting_particpant'] = 'Troubleshooting Participant Tip sheet link';
...
$string['record_force_desc'] = 'Force all Adobe Connect meetings to be recorded.'.
    '  This is a site wide effect and the Adobe Connect server must be restarted';
...
$string['conntestintro'] = '<p>A series of tests have been run in order to determine whether the Adobe Connect Pro server'.
    ' has been properly setup for this integration to work and to also determine whether the user credentials provided in the'.
    ' activity global settings has the correct permissions to perform the neccessary tasks required by the'.
    ' activity module.  If any of the tests below have failed, this activity module will not function properly.</p><p>'.
    ' For further assistance and documentation in how to set up your'.
...
$string['erroruser'] = 'Error creating user.';
$string['erroruserperm'] = 'Error setting user permissions.';
$string['errortimeout'] = 'A connection timeout occurred when saving the meeting. Please re-attempt by saving the meeting.';

$string['settingblurb'] = '<img src="{$a->image}" /><br />
...
$string['meeturl_help'] = '<p>You can customize the URL that is used to connect to the Adobe connect meeting.
    The Adobe Server domain will always remain the same.
...
<p>For example if the Adobe Connect server domain was located at <b>http://adobe.connect.server/</b>
  when customizing the URL to <b>mymeeting</b>, the URL to connect to the meeting would be
  <b>http://adobe.connect.server/mymeeting</b>.  Leave out the trailing forward slash
</p>
...
$string['modulename'] = 'Adobe Connect';
$string['modulename_help'] = 'The adobe connect activity provides integration method between Moodle and Adobe Connect. This
    integration is designed to simplify the use of synchronous events within Moodle. It provides a
    connection between the two systems with easy creation and management of Adobe Connect meetings.';

$string['recording'] = '';
$string['recording_help'] = '<h1>Recording access</h1>

<h2>Make Public</h2>
<p>The selected recordings will be given public access, allowing anyone who has the url of the recording
to view the recording.</p>
<h2>Make Private</h2>
<p>The selected recordings will be set to be private, limiting access to moodle users who have access to this meeting.</p>
<h2>Hide</h2>
<p>The selected recordings will only be visible to the meeting host</p>
<h2>Show</h2>
<p>The selected recordings will be visible to all user who have access to this meeting.</p>';
...
$string['recordingaccess'] = 'Access';
$string['recordingaccess_public'] = 'Public';
$string['recordingaccess_private'] = 'Private';
$string['recordingurl'] = 'URL for Sharing';
$string['recordingedit'] = 'Edit';
$string['recordingviewed'] = 'Viewed';
$string['recordingoffline'] = 'Offline';

$string['recordingemptyvalue'] = '---';
$string['recordingeditbutton'] = 'Edit';
$string['recordingofflinebutton'] = 'Make Offline';
$string['recordingviewedbutton'] = 'List';
$string['recordingprivatebutton'] = 'Make Private';
$string['recordingpublicbutton'] = 'Make Public';
$string['recordingeditadobebutton'] = 'Edit recording';
$string['recordingsavebutton'] = 'Save';
$string['recordingshowbutton'] = 'Show';
$string['recordinghidebutton'] = 'Hide';
$string['recordingcancelbutton'] = 'Close';

$string['recordinghelpbutton'] = '';
$string['recordingedit_title'] = 'Recording information';
$string['recordingedit_dates'] = 'Start date - End date';
$string['recordingedit_name'] = 'Title';
$string['recordingedit_description'] = 'Summary';


$string['recordinglog_title'] = 'Watched recording';
$string['recordinglog_summary'] = 'All users who have viewed <i>{$a}</i>.';
