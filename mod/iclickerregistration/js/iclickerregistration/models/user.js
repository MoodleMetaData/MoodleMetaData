...
module.exports = function(app) {
    var model_name = 'M.mod_iclickerregistration.models.User';
    app.factory(model_name,
        ['$resource',
            function($resource) {
                return $resource('rest.php/users/:idnumber',
                    {
                        idnumber: '@idnumber',
                        course_module_id: utility.get_query_params().id
                    },
                    {
                        'get':    {method:'GET'},
                        /*'query':  {method:'GET'}, In the future when there is some
