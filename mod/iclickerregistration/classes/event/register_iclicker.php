 ...
 */
class register_iclicker extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventregistericlicker', 'mod_iclickerregistration');
    }

    public function get_description() {
        global $DB;
        $iclickerregistrationuser = $DB->get_record($this->objecttable, array('id' => $this->objectid));
        return "The user with id {$this->userid} registered iClicker ID: {$iclickerregistrationuser->iclickerid}.";
    }
}