 ...
 */
class delete_iclicker extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdeleteiclicker', 'mod_iclickerregistration');
    }

    public function get_description() {
        return "The user with id {$this->userid} deleted his/her iClicker ID.";
    }
}