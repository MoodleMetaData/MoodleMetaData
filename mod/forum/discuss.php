...
// Local eClass modification LMS-349.
// Search at bottom of centre column instead of in place of edit button.

$renderer = $PAGE->get_renderer('mod_forum');

echo $OUTPUT->header();

// Make the heading have a link back to the main forum page.
$forumname = format_string($forum->name);
$forumlink = "$CFG->wwwroot/mod/forum/view.php?f=$forum->id";
$linkhtml = $OUTPUT->action_link($forumlink, $forumname);
