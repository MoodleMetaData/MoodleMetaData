...
$string['forcesubmitall'] = 'Force submit all attempts';
$string['forcesubmitselected'] = 'Force submit selected attempts';
$string['forcesubmitgroup'] = 'Force submit all attempts in group \'{$a->groupname}\'';
$string['forcesubmittingattemptxofy'] = 'Force submitting attempt ({$a->done}/{$a->count})';
$string['forcesubmitcomplete'] = 'Force submit completed successfully';
$string['areyousureforcesubmitattempts'] = 'Are you sure you want to force submit attempts for this quiz?';
