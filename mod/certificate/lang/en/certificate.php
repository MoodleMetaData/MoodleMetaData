...
$string['borderstyle_help'] = 'Note: Border images are not recommended for portrait certificates. Select the border image that you want around the certificate edges or select no border.';
...
$string['printseal_help'] = 'Note: Contact eclass@ualberta.ca for information about uploading seal images. This option allows you to select a seal or logo image. By default, this image is placed in the lower right corner of the certificate.';
$string['printsignature'] = 'Signature Image';
$string['printsignature_help'] = 'Note: Contact eclass@ualberta.ca for more information about uploading signatures. This option allows you to print a signature image or print a line for a written signature. By default, this image is placed in the lower left of the certificate. You are also able to link to a signature image in the custom text area.';
...
$string['printwmark_help'] = 'Note: Watermark images will be added in the future. Contact eclass@ualberta.ca for more information. A watermark file can be placed in the background of the certificate. A watermark is a faded graphic. A watermark could be a logo, seal, crest, wording, or whatever you want to use as a graphic background.';
...
$string['typeA4_non_embedded'] = 'A4';
$string['typeletter_embedded'] = 'Letter Embedded';
$string['typeletter_non_embedded'] = 'Letter';
...
$string['previewsection'] = 'Preview';
$string['previewsectioninstruction'] = 'To use preview feature, click "Save and Display" then click "Certificate administration->Edit Settings" on the Navigation bar';
$string['certificatepreviewtitle'] = 'Certificate Preview';