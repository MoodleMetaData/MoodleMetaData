 ...
 * @param int $certissuerecordid the certificate issue record id
 * @param string $filename pdf filename
 * @param int $contextid context id
 * @return bool return true if successful, false otherwise
 */
function certificate_save_pdf($pdf, $certissuerecordid, $filename, $contextid) {
    global $USER;

    if (empty($certissuerecordid)) {
        return false;
    }
    ...
    $fileinfo = array(
        ...
        'itemid'    => $certissuerecordid,  // usually = ID of row in table
    ...
    $fs->delete_area_files($contextid, $component, $filearea, $certissuerecordid);
...
/**
 * Get the course outcomes for mod_form print outcome.
 *
 * @return array
 */
