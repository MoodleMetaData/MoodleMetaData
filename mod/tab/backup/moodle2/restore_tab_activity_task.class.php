...
/**
 * tab restore task that provides all the settings and steps to perform one
...
class restore_tab_activity_task extends restore_activity_task {
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('tab', 'add', 'view.php?id={course_module}', '{tab}');
        $rules[] = new restore_log_rule('tab', 'update', 'view.php?id={course_module}', '{tab}');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('tab', 'view all', 'index.php?id={course}', null);
