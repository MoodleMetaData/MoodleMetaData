 ...
 */
if (file_exists($CFG->dirroot . '/enrol/imsenterprise/locallib.php')) {
...
$PAGE->set_url('/local/contextadmin/cat_settings.php',
               array('section' => $section, 'name' => $modname, 'contextid' => $contextid));
...
if (file_exists($CFG->dirroot . '/local/contextadmin/mod/' . $modname . '/cat_settings.php')) {
    ...
    $settings =
        new category_settingpage($section, $modname, 'local/contextadmin:editowncatsettings',
