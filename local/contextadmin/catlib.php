...
class category_settingpage implements part_of_category
{
     ...
     * @param mixed $reqcapability The role capability/permission a user must have to access this external page. Defaults to
     * 'moodle/site:config'.
     ...
     */
    public function __construct($name, $visiblename, $reqcapability = 'moodle/site:config', $context = null) {
        global $PAGE;
        $this->visiblename = '';
