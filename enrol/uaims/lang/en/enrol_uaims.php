...
$string['createnewcourses_desc'] = 'If enabled, the UofA IMS Enterprise enrolment plugin can create new courses for any it finds in the IMS data but not in Moodle\'s database. Any newly-created courses are initially hidden.';
$string['createnewusers'] = 'Create user accounts for users not yet registered in Moodle';
$string['createnewusers_desc'] = 'UofA IMS Enterprise enrolment data typically describes a set of users. If enabled, accounts can be created for any users not found in Moodle\'s database.

Users are searched for first by their "idnumber", and second by their Moodle username. Passwords are not imported by the UofA IMS Enterprise plugin. The use of an authentication plugin is recommended for authenticating users.';
$string['cronfrequency'] = 'Frequency of processing';
$string['deleteusers'] = 'Delete user accounts when specified in IMS data';
$string['deleteusers_desc'] = 'If enabled, UofA IMS Enterprise enrolment data can specify the deletion of user accounts (if the "recstatus" flag is set to 3, which represents deletion of an account). As is standard in Moodle, the user record isn\'t actually deleted from Moodle\'s database, but a flag is set to mark the account as deleted.';
$string['doitnow'] = 'perform an UofA IMS Enterprise import right now';
$string['enableautocourseopenclose'] = 'Enable automatic course opening/closing';
$string['enableautocourseopenclosedesc'] = 'If set, courses will become available to students on the start date and become unavailable on the end date based on the internally stored data. This will also
disable external visibility changes via uaims.';
$string['enableqrvisibilitytoggle'] = 'Enable QR visibility toggleing.';
$string['enableqrvisibilitytoggledesc'] = 'If set, QR requests to update a course will allow visibility to be toggled.';
...
$string['imsrolesdescription'] = 'The UofA IMS Enterprise specification includes 8 distinct role types. Please choose how you want them to be assigned in Moodle, including whether any of them should be ignored.';
...
$string['pluginname'] = 'UofA IMS Enterprise file';
$string['pluginname_desc'] = 'This method will repeatedly check for and process a specially-formatted text file in the location that you specify.  The file must follow the UofA IMS Enterprise specifications containing person, group, and membership XML elements.';
...
$string['restricttarget_desc'] = 'An UofA IMS Enterprise data file could be intended for multiple "targets" - different LMSes, or different systems within a school/university. It\'s possible to specify in the Enterprise file that the data is intended for one or more named target systems, by naming them in <target> tags contained within the <properties> tag.
...
$string['importimsfile'] = 'Import UofA IMS Enterprise file';
$string['uaims:config'] = 'Configure uaims enrol instances';
